"""
EM training with CLAMPED E-step and VISIBLE loss, sweeping hidden cell fraction.
...
The hidden_cell_fraction parameter is varied by the grid search in run_grid_search.py.
"""
