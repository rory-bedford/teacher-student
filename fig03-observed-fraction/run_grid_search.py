...
SEEDS = [44, 45, 46]
#: 0.5%, 1% and 2% are the unreliable end: below ~25% observed a run either trains or collapses (the
...
#: show where the fit stops being reliable, with all three seeds each.
OBSERVED_FRACTIONS = [0.005, 0.01, 0.02, 0.05, 0.1, 0.25]
