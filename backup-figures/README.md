...
The six tied scaling factors (learnt / true), fully observed beside Figure 1's 10% observed.
...
- **10% observed** (`fig01-full-reconstruction/seed-*`, Figure 1's own runs): the same factors land at
...
most of the network is simulated, and the distance from 1.0 is roughly the size of the gap to
...
Error bars need more than one run per condition: the 10% side gains seeds 45 and 46 from
