"""
Grid search over varying hidden unit fractions.

Tests network robustness by training with 10% to 90% of neurons hidden.
...
def custom_config_generator(base_params):
    ...
    for fraction in np.arange(0.05, 0.55, 0.05):
        ...
        params["hidden_units"]["hidden_unit_fraction"] = float(fraction)
        yield params, f"hidden-{fraction:.2f}"
